...
/* tox and toy for X,Y in buffer 
   ...
   ++X and ++Y, X = 1 */
//extern int tox;
//extern int toy; // see TORECU/toxy.c/h
...
#define TO(name) void func_to_##name (Stokenizer *tokenizer)
...
// use to get the string that regex matched... eg string "123" and regex "0-9+"
